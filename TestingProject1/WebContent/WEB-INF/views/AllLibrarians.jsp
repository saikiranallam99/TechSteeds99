...
<c:forEach  items="${librarians}" var="librarians">
<tr>
 <td><c:out value="${librarians.librarianName}"/></td>
 <td><c:out value="${librarians.librarianEmail}"/></td>
 <td><c:out value="${librarians.librarianDateOfBirth}"/></td> 
 <td><c:out value="${librarians.librarianPhone}"/></td>  
 <td>
